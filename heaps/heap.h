 ...
 * array by doubling its amount. This may need to copy 
 * the data of old array to new array, secondly insert
 * the new data element into the end of the array and
 * update size.
 */
